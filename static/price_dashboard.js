document.addEventListener('DOMContentLoaded', function() {
    ...
    var allItems = window.allItems || [];
    var tasksByColumn = window.tasksByColumn || [];
    ...
    function initPriceDashboard() {
        console.log('initPriceDashboard called, items:', allItems.length);
        if (typeof Chart === 'undefined') { console.log('Chart not loaded'); return; }
        
        var tableBody = document.getElementById('priceTableBody');
        if (!tableBody) { console.error('priceTableBody not found'); return; }
    ...
    // Initialize
    function initAll() {
        console.log('initAll called, Chart available:', typeof Chart !== 'undefined');
