document.addEventListener('DOMContentLoaded', function() {
    ...
    function initPriceDashboard() {
        ...
        console.log('DOM elements:', { histogramCanvas: !!histogramCanvas, scatterCanvas: !!scatterCanvas, tableBody: !!tableBody });
        ...
        function updateTable(items) {
            console.log('updateTable called with', items.length, 'items');
            tableBody.innerHTML = '';
