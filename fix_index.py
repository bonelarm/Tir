...
# Part before script
part1 = ''.join(lines[:script_start+1])  # includes <script> line

# Part after script (includes </script> line)
part2 = ''.join(lines[script_end:])

# New clean script content - single quotes for JS strings to avoid escape issues
new_script = """<script>
...
# Write new file
with open('C:/Users/levon_as/Desktop/Tir/templates/index_new.html', 'w', encoding='utf-8') as f:
    f.write(part1 + new_script + part2)

print('New file written: index_new.html')
print('Please rename index_new.html to index.html to apply changes')
